...
if __name__ == "__main__":
    ...
    for epoch in range(args.epochs):
        ...
        for minibatch_index in tqdm(range(N // minibatch_size)):
            ...
            loss.backward()
            optimizer.step()
        train_loss = loss.item()  # Store the final minibatch loss for this epoch
    ...
    ax1.plot(epochs, train_losses, color='tab:blue', label='Training Loss')
    ax1.tick_params(axis='y', labelcolor='tab:blue')

    # Create a second y-axis for validation accuracy
    ax2 = ax1.twinx()
    ax2.set_ylabel('Validation Accuracy', color='tab:red')
    ax2.plot(epochs, val_accuracies, color='tab:red', label='Validation Accuracy')
